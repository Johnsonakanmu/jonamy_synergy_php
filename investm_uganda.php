<div class="sec-title centered">
  <h2>Investment Projects in Uganda</h2>
      ...
      <div class="row clearfix" style="margin-top: 75px;">
        ...
        <div class="services-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
            ...
            <div class="text">The project involves developing a medium-scale housing complex on a 30-acre plot leased by
        ...
        <div class="services-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
            ...
            <div class="text">Construction of a 205 km inland pipeline from the Hoima refinery to Buloba terminal near
